...
const Navbar: FC = () => {
  ...
  return (
    <>
      <AppBar sx={{ position: 'sticky', boxShadow: 0, bgcolor: 'white' }}>
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', width: '100%', px: 2, position: "relative" }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', marginLeft: "auto", marginRight: "10%", backgroundColor: theme.palette.background.paper }}>
